...
config_svhn = copy.deepcopy(config_celeba)
config_svhn['dataset'] = 'svhn'
config_svhn['n_classes'] = 10
config_svhn['batch_size'] = 50
config_svhn['lr'] = 5e-5
config_svhn['lambda'] = 10.
config_svhn['zdim'] = 64
config_svhn['hdim'] = 2 * 2 * 1024
config_svhn['e_num_layers'] = 4
config_svhn['mlp_classifier'] = False
config_svhn['augment_z'] = True
config_svhn['augment_x'] = False
config_svhn['LVO'] = False
config_svhn['eval_strategy'] = 2
config_svhn['aug_rate'] = 0.6
...
config_fashion['augment_z'] = True
config_fashion['augment_x'] = False
config_fashion['aug_rate'] = 0.6
config_fashion['LVO'] = False
